 ...
 * @prop {Record<'base'|'ansi'|'brightOther'|'other', string[]>} oogway - Oogway color variables.
...
const transformSoft = theme => {
    ...
    const brightColors = [...soft.oogway.ansi, ...soft.oogway.brightOther];
